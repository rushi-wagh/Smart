...
const MyIssues = () => {
  ...
  const data = activeTab === "my" ? myIssues : allIssues;
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-2 mt-4 text-xs">
                    <span
                      className={`px-3 py-1 rounded-full font-medium ${statusColor[issue.status]}`}
                    >
                      {issue.status}
                    </span>

                    <span
                      className={`px-3 py-1 rounded-full font-medium ${priorityColor[issue.priority]}`}
                    >
                      {issue.priority}
                    </span>
